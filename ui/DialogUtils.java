...
public class DialogUtils {
    public static void showError(Component parent, String message) {
        ...
        UIManager.put("Button.setFont", new Font("Segoe UI", Font.BOLD, 14));
    ...
    public static void showMessage(Component parent, String message) {
        UIManager.put("OptionPane.background", new Color(31, 31, 46));
        UIManager.put("Panel.background", new Color(31, 31, 46));
        UIManager.put("OptionPane.messageForeground", new Color(71, 202, 50));
        UIManager.put("Button.background", new Color(71, 202, 50));
        UIManager.put("Button.foreground", new Color(31, 31, 46));
        UIManager.put("Button.setFont", new Font("Segoe UI", Font.BOLD, 14));
